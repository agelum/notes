...
const initialCards: KanbanCard[] = [
  {
    ...
    columnId: 'backlog',
    labels: [
      { id: 'l1', name: 'Research', color: 'blue' },
    ],
    assignees: [
  ...
  },
  {
    ...
    description: 'Set up the design system with Figma and create component library',
    columnId: 'backlog',
    labels: [
  ...
  },
  {
    ...
    assignees: [
      { id: 'u3', name: 'Mike Johnson', avatar: 'https://i.pravatar.cc/150?u=mike' },
      { id: 'u1', name: 'John Doe', avatar: 'https://i.pravatar.cc/150?u=john' },
    ],
  ...
  },
  {
    ...
    columnId: 'review',
    labels: [
      { id: 'l7', name: 'Testing', color: 'orange' },
    ],
    assignees: [
      { id: 'u3', name: 'Mike Johnson', avatar: 'https://i.pravatar.cc/150?u=mike' },
    ],
  ...
  },
  {
    ...
    columnId: 'done',
    labels: [
      { id: 'l8', name: 'DevOps', color: 'indigo' },
    ],
    assignees: [
      { id: 'u1', name: 'John Doe', avatar: 'https://i.pravatar.cc/150?u=john' },
      { id: 'u2', name: 'Jane Smith', avatar: 'https://i.pravatar.cc/150?u=jane' },
